...
class TestCustomerForm(unittest.TestCase):
    ...
    # Invalid data
        ...
        result = self.driver.find_element(By.ID, "firstName").text
        self.assertEqual("First Name: john", result)  # Adjust assertion for invalid data
...
#        drp_title.select_by_index(0)
    ...
    # Invalid data
#        name.send_keys("johnjohnjohnjohn")  # Invalid first name
#        last.send_keys("canoncan")
#        age.send_keys("75")
...
#        result = self.driver.find_element(By.ID, "firstName").text
#        self.assertEqual("First Name: johnjohnjohnjohn", result)  # Adjust assertion for invalid data
    ...
    # Invalid data
        ...
        result = self.driver.find_element(By.ID, "firstName").text
        self.assertEqual("First Name: johnjohn", result)  # Adjust assertion for invalid data
